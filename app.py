...
app.config['SQLALCHEMY_DATABASE_URI'] = f"mysql://{os.getenv('DB_USER', 'root')}:{os.getenv('DB_PASSWORD', 'zx123456')}@{os.getenv('DB_HOST', 'localhost')}/{os.getenv('DB_NAME', 'ai_boyfriend')}"
